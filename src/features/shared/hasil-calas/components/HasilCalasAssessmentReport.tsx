...
import type { RingkasanPenilaian, RingkasanTipeUjian } from '@/features/master-data/modules/detail-calas/types/detailCalas.types';
    ...
    return (
      <div className="mb-8">
        ...
        <div className="text-center py-12 bg-gray-50/50 rounded-xl border border-dashed border-gray-300">
          <p className="text-sm text-gray-500 font-medium">Belum ada penilaian Ujian {title} untuk Anda.</p>
        </div>
      </div>
    );
  }
...
const HasilCalasAssessmentReport: React.FC<Props> = ({ penilaian }) => {
  return (
...
export default HasilCalasAssessmentReport;
