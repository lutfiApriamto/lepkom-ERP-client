...
import { calasSoalMenu } from '@/routes/config/menu/soal-calas';

const CalasSoalDashboard = () => {
  ...
  useEffect(() => {
    setBreadcrumbItems([
      ...
      { label: 'Soal & Upload Jawaban', path: path.lepkom.masterData.default },
    ]);
    return () => setBreadcrumbItems([]);
  }, [setBreadcrumbItems]);

  // Filter menus based on user role
  const allowedMenus = calasSoalMenu.children.filter((menu) => {
...
export default CalasSoalDashboard;
